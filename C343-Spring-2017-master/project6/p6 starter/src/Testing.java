...
@Test
  public void testBuildKMP() {
    ...
    assertEquals(StringMatch.buildKMP("AAAA", random), 3);
    assertEquals(StringMatch.buildKMP("BAAA", random), 6);
    assertEquals(StringMatch.buildKMP("AAAB", random), 6);
    assertEquals(StringMatch.buildKMP("AAAC", random), 6);
    assertEquals(StringMatch.buildKMP("ABAB", random), 4);
