...
public class Testing {
  ...
  public void swapTest(){
	  ...
	  heap.insert(3);
	  heap.swap(1, 2);
	  assertArrayEquals(new Object[] {1, 3, 2}, heap.keys.toArray());
	  heap.swap(0, 2);
	  assertArrayEquals(new Object[] {2, 3, 1}, heap.keys.toArray());
	  heap.swap(2, 1);  
	  assertArrayEquals(new Object[] {2, 1, 3}, heap.keys.toArray());
 ...
 //@Test
  public void catInHat() {
    ...
    System.out.println(ht.root.priority);
