...
public class Util {
  ...
  public static double cosineSimilarity(ColorTable A, ColorTable B) {
	  ...
	  /*
	   * cosine similarity will be the dot product / ||A|| * ||B||
	   */
  ...
  /*
   * this is the pseudocode I had for a helper function that produces the dot product for the vectors. I commented this out because of an error marker.
  private static double dproduct(ColorTable A, ColorTable B, int n){
